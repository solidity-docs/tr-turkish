...
Ayrıca, operatörler içeren ifadelerde türler birbirleriyle etkileşime girebilirler.
...
Beklenmeyen değerler ile uğraşırken, tüm işlemi geri almak için bir :ref:`geri alma işlevi<assert-and-require>` kullanmalı ya da sonucu işaret eden ikinci bir ``bool`` değerine sahip bir veri demeti döndürmelisiniz.
