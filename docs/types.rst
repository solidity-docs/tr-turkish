...
Solidity statik olarak yazılmış bir dildir, bu, her bir değişkenin türünün (state ve local) belirtilmesi gerektiği anlamına gelir.
...
Solidity'de "undefined" veya "null" değerler kavramı yoktur, yeni bildirilen değişkenlerin türüne bağlı olarak her zaman :ref:`varsayılan bir değeri<default-value>` vardır.
